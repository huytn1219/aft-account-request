...
module "sandbox_account_01" {
  ...
  control_tower_parameters = {
    AccountEmail = "huy.nguyen@gmail.com"
    AccountName  = "dev-account-1"
    # Syntax for top-level OU
    ManagedOrganizationalUnit = "Sandbox"
    # Syntax for nested OU
    # ManagedOrganizationalUnit = "Sandbox (ou-xfe5-a8hb8ml8)"
    SSOUserEmail     = "huy.nguyen@gmail.com"
    SSOUserFirstName = "Huy"
    SSOUserLastName  = "Nguyen"
  }

  account_tags = {
    "ABC:Owner"       = "huy.nguyen@amazon.com"
    "ABC:Division"    = "ENT"
    "ABC:Environment" = "Dev"
...
module "sandbox_account_02" {
  ...
  control_tower_parameters = {
    AccountEmail = "huy.nguyen2@gmail.com"
    AccountName  = "dev-account-2"
    # Syntax for top-level OU
    ManagedOrganizationalUnit = "Sandbox"
    # Syntax for nested OU
    # ManagedOrganizationalUnit = "Sandbox (ou-xfe5-a8hb8ml8)"
    SSOUserEmail     = "huy.nguyen2@gmail.com"
    SSOUserFirstName = "Huy"
    SSOUserLastName  = "Nguyen"
  }

  account_tags = {
    "ABC:Owner"       = "huy.nguyen2@amazon.com"
    "ABC:Division"    = "ENT"
    "ABC:Environment" = "Dev"
    "ABC:CostCenter"  = "123456"
    "ABC:Vended"      = "true"
